...
void main (void) {
	...
	/* fragment color */
	color = applyTexture2D(u_Texture0, MODULATE, gl_TexCoord[0], gl_TextureEnvColor[0], color);
	
	/* multi-texturing */
	if (u_TexEnv > -1) {
		color = applyTexture2D(u_Texture1, u_TexEnv, gl_TexCoord[1], gl_TextureEnvColor[1], color);
	}
